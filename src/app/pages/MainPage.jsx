...
const TECH_STACK = ["React.js", "Javascript", "Node.js","Express.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/OmkarSawantt" },
  { icon: Linkedin, link: "www.linkedin.com/in/omkar-sawantt" },
];
...
const MainPage = () => {
  ...
  const lottieOptions = {
    src: "https://lottie.host/1e6d6508-3a66-4a18-b4b7-1e9cbd5e360e/ggDqmR1gbn.lottie",
    loop: true,
    autoplay: true,
      ...
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            {/* Left Column */}
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-center order-1 lg:order-1 lg:mt-0"
              data-aos="fade-right"
              data-aos-delay="200">
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Innovative Web Developer passionate about building scalable and user-friendly digital experiences.
                </p>
                </div>
